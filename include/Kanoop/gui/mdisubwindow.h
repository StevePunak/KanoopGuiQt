...
public:
     ...
     *
     * ⚠ One type shared by two classes is permitted. The second class is offset from whatever of
     * the shared type is already open, and its own stored position is not consulted.
     */
